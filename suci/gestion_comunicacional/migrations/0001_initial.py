# Generated by Django 5.0.6 on 2024-06-08 11:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delete_at', models.DateTimeField(auto_now=True, null=True, verbose_name='Eliminado el')),
                ...
                ('delete_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_delete', to=settings.AUTH_USER_MODEL, verbose_name='Eliminado por')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Actualizado el')),
                ('delete_at', models.DateTimeField(auto_now=True, null=True, verbose_name='Eliminado el')),
                ('platform', models.CharField(choices=[('Facebook', 'Facebook'), ('Instagram', 'Instagram'), ('Twitter', 'Twitter')], max_length=50, verbose_name='Red social')),
                ('username_sm', models.CharField(max_length=60, unique=True, verbose_name='Nombre de usuario de la red social')),
                ...
                ('responsible', models.CharField(max_length=100, verbose_name='Responsable de la red social')),
